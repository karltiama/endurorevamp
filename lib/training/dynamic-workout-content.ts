...
export class DynamicWorkoutContent {
  ...
  static generateInstructions(context: DynamicContentContext): string[] {
    ...
    instructions.push(
      ...this.getWarmupInstructions(sport, intensity, timeOfDay)
    );
  ...
  private static getWarmupInstructions(
    sport: string,
    intensity: number,
    timeOfDay?: string
  ): string[] {
  ...
  private static getMainWorkoutInstructions(
    workoutType: string,
    sport: string
  ): string[] {
    const instructions: string[] = [];
  ...
  private static getCooldownInstructions(
    sport: string,
    intensity: number
  ): string[] {
    const instructions: string[] = [];
  ...
  private static getWeatherAdjustments(weather: {
    temperature: number;
    precipitation: number;
    windSpeed: number;
  }): string[] {
  ...
  private static getWorkoutTypeTips(
    workoutType: string,
    sport: string
  ): string[] {
    const tips: string[] = [];
  ...
  private static getWeatherTips(weather: {
    temperature: number;
    precipitation: number;
    windSpeed: number;
  }): string[] {
  ...
  private static getEasierModification(
    workoutType: string,
    sport: string
  ): string {
    if (sport === 'Run') {
  ...
  private static getHarderModification(
    workoutType: string,
    sport: string
  ): string {
    if (sport === 'Run') {
  ...
  private static getShorterModification(
    workoutType: string,
    sport: string
  ): string {
    if (sport === 'Run') {
  ...
  private static getLongerModification(
    workoutType: string,
    sport: string
  ): string {
    if (sport === 'Run') {
  ...
  static generateDynamicContent(
    ...
    context?: Partial<DynamicContentContext>
  ): {
    instructions: string[];
    tips: string[];
    modifications: {
