...
const mockUseSynchronizedTodaysWorkout = useSynchronizedTodaysWorkout as jest.MockedFunction<typeof useSynchronizedTodaysWorkout>
const mockUseWorkoutPlanManager = jest.requireMock('@/hooks/useEnhancedWorkoutPlanning').useWorkoutPlanManager as jest.MockedFunction<any>
const mockUseWorkoutPlanAnalytics = jest.requireMock('@/hooks/useEnhancedWorkoutPlanning').useWorkoutPlanAnalytics as jest.MockedFunction<any>
...
describe('EnhancedWorkoutPlanningDashboard', () => {
  ...
  beforeEach(() => {
    ...
    jest.requireMock('@/hooks/useUnitPreferences').useUnitPreferences.mockReturnValue({
      preferences: {
        distance: 'km',
        temperature: 'celsius',
        windSpeed: 'kmh'
    ...
    const mockWeeklyPlan = {
      ...
      workouts: {
        ...
        1: { // Monday
          ...
          alternatives: [],
          instructions: ['Warm up for 10 minutes', 'Run at tempo pace for 25 minutes', 'Cool down for 10 minutes'],
