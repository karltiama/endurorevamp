...
describe('LiveDashboardPreview', () => {
  ...
  it('renders weekly activity chart', () => {
    ...
    expect(screen.getByText('Weekly Activity')).toBeInTheDocument()
    expect(screen.getByText('Your running activity over the past week')).toBeInTheDocument()
  ...
  it('renders goal progress section', () => {
    ...
    expect(screen.getByText('Goal Progress')).toBeInTheDocument()
    expect(screen.getByText('Track your progress toward running goals')).toBeInTheDocument()
  ...
  it('renders training load and recovery cards', () => {
    ...
    expect(screen.getByText('Weekly training stress balance')).toBeInTheDocument()
    expect(screen.getByText('Training Stress Score')).toBeInTheDocument()
    expect(screen.getByText('Optimal Range')).toBeInTheDocument()
    
    expect(screen.getByText('Recovery Status')).toBeInTheDocument()
    expect(screen.getByText('How ready you are for your next run')).toBeInTheDocument()
