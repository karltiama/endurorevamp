...
describe('GoalsSelectionStep', () => {
  ...
  it('displays goal suggestions', () => {
    ...
    expect(
      screen.getByText('Establish Training Frequency')
    ).toBeInTheDocument();
  ...
  it('allows selecting and deselecting goals', () => {
    ...
    const firstGoal = screen
      .getByText('Build Weekly Distance')
  ...
  it('shows goal benefits and strategies', () => {
    ...
    expect(
      screen.getByText('Gradually increase your weekly running distance')
    ).toBeInTheDocument();
    expect(
      screen.getByText('Run consistently throughout the week')
    ).toBeInTheDocument();
  });
