...
describe('ActivityDetailModal', () => {
  ...
  it('renders activity details correctly', () => {
    render(
      <ActivityDetailModal activity={mockActivity} onClose={mockOnClose} />
    );
  ...
  it('does not display pace for non-running activities', () => {
    ...
    render(
      <ActivityDetailModal activity={cyclingActivity} onClose={mockOnClose} />
    );
  ...
  it('handles missing optional metrics gracefully', () => {
    ...
    render(
      <ActivityDetailModal activity={minimalActivity} onClose={mockOnClose} />
    );
  ...
  describe('RPE functionality', () => {
    it('shows RPE section', () => {
      ...
      expect(
        screen.getByText('How did this workout feel?')
      ).toBeInTheDocument();
    });
