...
describe('ActivityCard', () => {
  ...
  const createMockActivity = (overrides: Partial<ActivityWithRPE> = {}): ActivityWithRPE => ({
    id: '1',
    user_id: 'user1',
  ...
  it('renders basic activity information', () => {
    ...
    renderWithQueryClient(<ActivityCard activity={activity} onViewDetails={mockOnViewDetails} />)
  ...
  it('adapts grid layout based on number of metrics', () => {
    ...
    const { rerender } = renderWithQueryClient(
      <ActivityCard activity={simpleActivity} onViewDetails={mockOnViewDetails} />
    )
    ...
    rerender(
      <QueryClientProvider client={queryClient}>
        <ActivityCard activity={complexActivity} onViewDetails={mockOnViewDetails} />
      </QueryClientProvider>
    )
