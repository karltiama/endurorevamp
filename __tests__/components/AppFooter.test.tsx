...
describe('AppFooter', () => {
  ...
  it('opens external links when developer links are clicked', async () => {
    ...
    const articleButton = screen.getByText(
  ...
  it('displays footer branding', () => {
    ...
    expect(
      screen.getByText('Built with passion for the fitness community')
    ).toBeInTheDocument();
    expect(
      screen.getByText('© 2024 Enduro Stats. All rights reserved.')
    ).toBeInTheDocument();
  });
