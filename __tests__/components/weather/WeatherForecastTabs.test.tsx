...
const createMockOptimalTime = () => ({
  time: '6:00 AM',
  reason:
    'Best conditions: comfortable temperature, low humidity, light winds, dry conditions, moderate UV, early morning (6-8 AM) - cooler temps, less traffic',
});
...
describe('WeatherForecastTabs', () => {
  ...
  it('renders error state', () => {
    ...
    expect(
      screen.getByText(
        'Unable to load weather data. Please check your location permissions.'
      )
    ).toBeInTheDocument();
  ...
  it('displays running recommendations', () => {
    ...
    const recommendationsElements = screen.getAllByText(
  ...
  it('can hide impact and optimal time sections', () => {
    ...
    expect(
      screen.queryByText('Running Recommendations')
