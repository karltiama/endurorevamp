...
describe('EnhancedPhoneMockup', () => {
  ...
  it('renders with custom dimensions', () => {
    render(<EnhancedPhoneMockup {...defaultProps} width={800} height={1600} />);
  ...
  it('applies custom className', () => {
    render(<EnhancedPhoneMockup {...defaultProps} className="custom-class" />);

    const container = screen
      .getByAltText('Test phone mockup')
