...
describe('ActivitiesDashboard', () => {
  ...
  describe('Loading State', () => {
    it('shows loading state when data is being fetched', () => {
      ...
      expect(
        screen.getByText('Loading your latest activities from database...')
      ).toBeInTheDocument();
  ...
  describe('Error State', () => {
    ...
    it('shows error state when there is an error', () => {
      ...
      expect(screen.getByText('Recent Activities')).toBeInTheDocument();
      expect(
        screen.getByText('Unable to load your activities from database')
      ).toBeInTheDocument();
      expect(
        screen.getByText('Failed to fetch activities')
      ).toBeInTheDocument();
  ...
  describe('Empty State', () => {
    it('shows empty state when no activities are returned', () => {
      ...
      expect(
        screen.getByText('No activities found in your database.')
      ).toBeInTheDocument();
      expect(
        screen.getByText(
  ...
  describe('Success State with Activities', () => {
    ...
    it('displays activities when data is loaded', () => {
      ...
      expect(screen.getByText('Recent Activities')).toBeInTheDocument();
      expect(
        screen.getByText('Your latest 2 activities from database')
      ).toBeInTheDocument();
