-- Final fix for workout plan save function
-- This script will completely replace the function with a working version
...
-- Create the new function with a completely different approach
...
SELECT 'After fix workout_plans data:' as info;
SELECT id, user_id, plan_name, week_start, is_active, created_at 
FROM workout_plans 
ORDER BY week_start DESC, is_active DESC; 