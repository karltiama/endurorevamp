-- Fix the total_time data type conversion issue
-- The database expects INTEGER but we're passing decimal values

-- Update the save_workout_plan function to properly handle decimal total_time values
...
BEGIN
  ...
  INSERT INTO workout_plans (
    ...
    COALESCE(ROUND((plan_data->>'totalTime')::DECIMAL, 0)::INTEGER, 0), -- Fixed: Convert decimal to integer
    true
  ) 
