          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <h3 className="font-medium text-sm truncate">{goal.goal_type?.display_name}</h3>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs">
              ...
              <span className="font-medium">
                {goal.target_value ? formatGoalValue(goal.target_value, goal, preferences.distance) : 'N/A'}
              </span>
            </div>
            ...
            <div className="flex justify-between text-xs">
              ...
              <span className={`font-medium ${getProgressColor(progressPercentage)}`}>
                {goal.target_value ? formatGoalValue(goal.current_progress, goal, preferences.distance) : '0'}
              </span>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex justify-between text-xs">
                ...
                {goal.target_value && goal.target_value > goal.current_progress && (
                  <span className="text-muted-foreground">
                    {formatGoalValue(goal.target_value - goal.current_progress, goal, preferences.distance)} left
                  </span>
                )}
              </div>
            </div>
