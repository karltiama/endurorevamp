...
export default function UnitPreferences() {
  const { preferences, isLoading, toggleUnits, updatePreferences } =
    useUnitPreferences();
  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        <CardTitle className="text-lg">Units & Display</CardTitle>
        <CardDescription className="text-sm">
          Choose your preferred units for distances, pace, and temperature
        </CardDescription>
      </CardHeader>
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <Button
                size="sm"
                variant={
                  preferences.distance === 'miles' ? 'default' : 'outline'
                }
                onClick={() => toggleUnits()}
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <Button
                size="sm"
                variant={
                  preferences.windSpeed === 'mph' ? 'default' : 'outline'
                }
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Button
                size="sm"
                variant={
                  preferences.temperature === 'celsius' ? 'default' : 'outline'
                }
