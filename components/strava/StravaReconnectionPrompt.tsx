        ...
        <div className="space-y-4 max-w-md">
            ...
            {isTokenExpired ? (
              <div className="space-y-3">
                <p className="text-gray-600">
                  Your Strava connection has expired. This is normal and happens
                  periodically for security reasons.
                </p>
                <Alert className="bg-blue-50 border-blue-200">
                  <Info className="h-4 w-4 text-blue-600" />
                  <AlertDescription className="text-blue-800">
                    <strong>Quick fix:</strong> Click &quot;Reconnect to
                    Strava&quot; below to restore access to your activities and
                    continue viewing your data.
                  </AlertDescription>
                </Alert>
              </div>
            ) : isNetworkError ? (
              <div className="space-y-3">
                <p className="text-gray-600">
                  There&apos;s a temporary connection issue with Strava. This
                  usually resolves itself quickly.
                </p>
                <Alert className="bg-yellow-50 border-yellow-200">
                  <Info className="h-4 w-4 text-yellow-600" />
                  <AlertDescription className="text-yellow-800">
                    Try refreshing your connection first, or reconnect if the
                    issue persists.
                  </AlertDescription>
                </Alert>
              </div>
              ...
              <div className="space-y-3">
                <p className="text-gray-600">
                  Unable to connect to Strava. This might be due to an expired
          ...
          <div className="text-sm text-gray-500">
            <p className="font-medium mb-1">
              After reconnecting, you&apos;ll be able to:
            </p>
