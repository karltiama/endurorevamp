...
const RPE_EMOJI_SCALE = [
  {
    ...
    emoji: '😴',
    label: 'Very Easy',
    description: 'Walking, very light effort',
  },
  {
    value: 2,
    emoji: '😌',
    label: 'Easy',
    description: 'Light jog, comfortable pace',
  },
  {
    value: 3,
    emoji: '🙂',
    label: 'Moderate',
    description: 'Steady pace, can talk easily',
  },
  {
    value: 4,
    emoji: '😐',
  ...
  },
  {
    ...
    emoji: '😤',
    label: 'Hard',
    description: 'Challenging pace, limited talking',
  },
  {
    value: 6,
    emoji: '😰',
    label: 'Very Hard',
    description: 'High effort, difficult to talk',
  },
  {
    value: 7,
    emoji: '😫',
    label: 'Very Hard+',
    description: 'Very challenging, minimal talking',
  },
  {
    value: 8,
    emoji: '😵',
    label: 'Extremely Hard',
    description: 'Maximum effort, no talking',
  },
  {
    value: 9,
    emoji: '🤯',
  ...
  },
  {
    ...
    emoji: '💀',
    label: 'All Out',
    description: 'Maximum effort, sprint finish',
  },
];
...
export function ActivityDetailModal({
  ...
  const handleSaveRPE = async () => {
    ...
    try {
      ...
      const activityId =
        'strava_activity_id' in activity
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        {formatDate(activity.start_date_local)} at{' '}
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label className="text-sm font-medium text-blue-800 mb-3 block">
                          Select the face that best represents how hard this
                          workout felt:
                        </Label>
                          ...
                          <div className="bg-blue-100 border border-blue-200 rounded-lg p-3">
                            <div className="flex items-center gap-2 mb-1">
                              <span className="text-xl">
                                {
                                  RPE_EMOJI_SCALE.find(
                                    r => r.value === selectedRPE
                                  )?.emoji
                                }
                              </span>
                    ...
                    <div className="flex items-center gap-3">
                      {currentRPEInfo ? (
                        ...
                        <div className="text-sm text-blue-600">
                          No effort rating yet. Click &quot;Add Effort&quot; to
                          rate this workout.
                        </div>
                      )}
                    </div>
                      ...
                      <div className="text-sm text-gray-700">
                        ...
                        {!activity.description && (
                          <p className="text-gray-500 text-xs mt-2">
                            💡 Tip: Detailed workout data (sets, reps) not
                            available from Strava.
                            <br />
                            Consider logging workouts directly in this app for
                            better tracking.
                          </p>
                        )}
                      </div>
                ...
                {activity.description &&
                  (() => {
                    const parsedWorkout = parseHevyWorkout(
                      activity.description
                    );
                    return (
                      <div className="mb-6">
                          ...
                          {parsedWorkout ? (
                            <div>
                              <div className="mb-3 text-sm text-gray-600">
                                ...
                                {parsedWorkout.totalVolume.toLocaleString()} lbs
                                <span className="mx-2">•</span>
                                <span className="font-medium">
                                  Total Sets:
                                </span>{' '}
                                {parsedWorkout.totalSets}
                              </div>
