...
export function SyncStateDebugger() {
  ...
  const getSyncStatusColor = () => {
    ...
    if (syncState.consecutive_errors && syncState.consecutive_errors > 0)
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          <Button onClick={fetchSyncState} disabled={isLoading} size="sm">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-gray-900">
                  {formatTimeAgo(syncState.last_activity_sync)}
                </p>
              ...
              <div>
                ...
                <p className="text-gray-900">
                  {syncState.last_sync_date || 'Never'}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-900">
                  {syncState.sync_requests_today || 0}/5
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-900">
                  {syncState.total_activities_synced || 0}
                </p>
              </div>
            </div>

            {/* Error Info */}
            {syncState.consecutive_errors &&
          ...
          <div className="text-center py-8 text-gray-500">
            {isLoading ? (
              ...
              <div>
                ...
                <p className="text-sm">
                  This usually means sync has never been run
                </p>
              </div>
            )}
          </div>
