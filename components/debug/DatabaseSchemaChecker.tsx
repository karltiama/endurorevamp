    ...
    try {
      ...
      if (columnsError) {
        ...
        setSchemaInfo({
          ...
          error:
            columns.length === 0
              ? 'No data found in activities table'
              : undefined,
        });
      } else {
        setSchemaInfo({
      ...
      <CardContent>
        <div className="space-y-4">
          <p className="text-sm text-gray-600">
            This will check what fields actually exist in your activities table
            vs what the migration files suggest.
          </p>

          {!schemaInfo && !isChecking && (
            <div className="text-center py-8 text-gray-500">
              Click &quot;Check Schema&quot; to see your actual database
              structure
            </div>
          )}
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <p className="text-sm text-yellow-700">
                  Compare this with your migration files. If they don&apos;t
