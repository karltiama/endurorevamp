    ...
    analytics: [
      {
        ...
        type: 'number',
        description: 'Normalized power / FTP for training zones',
        priority: 'high',
      },
      {
        field: 'variability_index',
        type: 'number',
        description: 'Power variability analysis',
        priority: 'medium',
      },
      {
        field: 'power_balance',
      ...
      },
      {
        field: 'fatigue_score',
        type: 'number',
        description: 'Cumulative fatigue indicator',
        priority: 'medium',
      },
      {
        field: 'aerobic_decoupling',
        type: 'number',
        description: 'Heart rate drift indicator',
        priority: 'medium',
      },
      {
        field: 'efficiency_factor',
        type: 'number',
        description: 'Power to heart rate ratio',
        priority: 'high',
      },
    ],
    weather: [
      {
        field: 'temperature',
        type: 'number',
        description: 'Temperature during activity (°C)',
        priority: 'medium',
      },
      {
        field: 'humidity',
      ...
      },
      {
        ...
        type: 'string',
        description: 'Weather description (sunny, rainy, etc.)',
        priority: 'medium',
      },
      {
        field: 'air_quality_index',
        type: 'number',
        description: 'Air quality during outdoor activities',
        priority: 'low',
      },
    ],
    social: [
      {
        field: 'strava_kudos_count',
        type: 'number',
        description: 'Kudos count from Strava',
        priority: 'low',
      },
      {
        field: 'internal_kudos_count',
        type: 'number',
        description: 'Kudos within our platform',
        priority: 'medium',
      },
      {
      ...
      },
      {
        ...
        type: 'json',
        description: 'Array of photo URLs/metadata',
        priority: 'low',
      },
      {
        field: 'tagged_athletes',
        type: 'json',
        description: 'Other athletes tagged in activity',
        priority: 'low',
      },
      {
    ...
    coaching: [
      {
        ...
        type: 'string',
        description: 'Link to planned workout',
        priority: 'high',
      },
      {
        field: 'workout_completed',
        type: 'boolean',
        description: 'Whether planned workout was completed',
        priority: 'high',
      },
      {
        field: 'workout_rating',
        type: 'number',
        description: 'User rating of workout (1-10)',
        priority: 'medium',
      },
      {
        field: 'coach_notes',
        type: 'text',
        description: 'Coach feedback on activity',
        priority: 'medium',
      },
      {
        field: 'training_phase',
        type: 'string',
        description: 'Current training phase (base, build, peak)',
        priority: 'medium',
      },
    ],
    equipment: [
      {
        field: 'bike_id',
        type: 'string',
        description: 'Specific bike used',
        priority: 'medium',
      },
      {
        field: 'wheel_circumference',
        type: 'number',
        description: 'For accurate speed/distance',
        priority: 'low',
      },
      {
        field: 'gear_ratios_used',
        type: 'json',
        description: 'Gear usage analytics',
        priority: 'low',
      },
      {
        field: 'equipment_wear',
        type: 'number',
        description: 'Track equipment usage',
        priority: 'low',
      },
      {
        field: 'tire_pressure',
        type: 'number',
        description: 'Pre-ride tire pressure',
        priority: 'low',
      },
    ],
    performance: [
      {
        field: 'vo2_estimate',
        type: 'number',
        description: 'Estimated VO2 max contribution',
        priority: 'high',
      },
      {
        field: 'lactate_threshold_power',
        type: 'number',
        description: 'Estimated LT power',
        priority: 'high',
      },
      {
        field: 'anaerobic_capacity',
        type: 'number',
        description: 'Anaerobic work capacity',
        priority: 'medium',
      },
      {
        field: 'neuromuscular_power',
        type: 'number',
        description: 'Peak 5-second power',
        priority: 'medium',
      },
      {
        field: 'critical_power',
        type: 'number',
        description: 'Sustainable power for 1 hour',
        priority: 'high',
      },
      {
        field: 'power_curve',
        type: 'json',
        description: 'Power duration curve data',
        priority: 'medium',
      },
    ],
    location: [
      {
        field: 'route_id',
        type: 'string',
        description: 'Link to saved route',
        priority: 'high',
      },
      {
        field: 'segment_efforts',
        type: 'json',
        description: 'Strava segment performance',
        priority: 'medium',
      },
      {
        field: 'elevation_profile',
        type: 'json',
        description: 'Detailed elevation data',
        priority: 'low',
      },
      {
        field: 'surface_type',
        type: 'string',
        description: 'Road, trail, track, etc.',
        priority: 'medium',
      },
      {
        field: 'location_tags',
        type: 'json',
        description: 'Custom location tags',
        priority: 'low',
      },
    ],
  };
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <ul className="text-sm text-yellow-700 space-y-1 list-disc list-inside">
              <li>
                <strong>average_pace field:</strong> This is likely where
                &quot;07:04 /km&quot; strings are being stored, causing type
                errors
              </li>
              <li>
                <strong>Advanced training fields:</strong> You already have TSS,
                normalized power, RPE, and recovery time!
              </li>
              <li>
                <strong>Zone data:</strong> power_zones, heart_rate_zones,
                pace_zones are stored as JSON
              </li>
              <li>
                <strong>Computed fields:</strong> week_number, efficiency_score
                etc. suggest custom analytics were added
              </li>
              <li>
                <strong>Missing social fields:</strong> athlete_count,
                photo_count, pr_count not in your schema
              </li>
              <li>
                <strong>No location fields:</strong> start_latlng, end_latlng
                missing
              </li>
            </ul>
          </div>
          ...
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <h4 className="font-medium text-green-800 mb-2">
              ✅ Already Implemented Training Features
            </h4>
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <ol className="text-sm text-blue-700 space-y-1 list-decimal list-inside">
              <li>
                <strong>Populate existing training fields</strong> - You have
                TSS, RPE, recovery time but may not be using them
              </li>
              <li>
                <strong>Build UI for zone analysis</strong> - power_zones,
                heart_rate_zones data is stored but needs visualization
              </li>
              <li>
                <strong>Handle average_pace</strong> field properly - it might
                need pace string conversion
              </li>
              <li>
                <strong>Create training load dashboard</strong> - leverage
                training_stress_score and intensity_score
              </li>
              <li>
                <strong>Add coaching features</strong> - planned workouts,
                workout rating, training phases
              </li>
              <li>
                <strong>Document computed fields</strong> - understand how
                efficiency_score and elevation_per_km are calculated
              </li>
            </ol>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-gray-600">
            Potential fields for upcoming features, organized by priority and
            use case
          </p>
        </CardHeader>
        <CardContent>
              ...
              return (
                ...
                >
                  <div className="text-sm text-gray-600 mb-4">
                    ...
                    features would enhance your endurance training app
                  </div>
          ...
          <div className="mt-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
            ...
            <div className="text-sm text-purple-700 space-y-2">
              <p>
                <strong>Phase 1 (Next):</strong> Build UI for existing training
                data (TSS dashboard, zone charts, RPE tracking)
              </p>
              <p>
                <strong>Phase 2:</strong> Add coaching workflow (planned
                workouts, workout rating, training phases)
              </p>
              <p>
                <strong>Phase 3:</strong> Implement advanced analytics (VO2
                estimates, critical power, power curves)
              </p>
              <p>
                <strong>Phase 4:</strong> Enhance with weather data and social
                features
              </p>
              <p>
                <strong>Phase 5:</strong> Add equipment tracking and advanced
                location features
              </p>
              <div className="mt-3 p-2 bg-purple-100 rounded text-xs">
                <strong>💡 Key Insight:</strong> You&apos;re further along than
                expected! Focus on utilizing existing data rather than adding
                new fields.
              </div>
            </div>
          </div>
