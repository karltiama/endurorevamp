  ...
  const metrics = [
    {
      ...
      value: `${mockWeeklyMetrics.totalDistance}`,
      unit: 'miles',
      icon: MapPin,
      color: 'text-blue-600',
    },
    {
      label: 'Training Load',
      value: mockWeeklyMetrics.trainingLoad,
      unit: 'TSS',
      icon: BarChart3,
    ...
    },
    {
      ...
      value: mockWeeklyMetrics.recoveryScore,
      unit: '%',
      icon: Heart,
    ...
    {
      label: 'Avg Pace',
      value: mockWeeklyMetrics.averagePace,
      unit: '/mile',
      icon: Clock,
        ...
        <div className="p-6 space-y-6">
            ...
            {metrics.map(metric => (
              ...
              >
                <CardContent className="p-4 text-center">
                  <div
                    className={`w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-3 ${metric.color.replace('text-', 'bg-')} bg-opacity-10`}
                  >
          ...
          <Card className="border-0 shadow-sm">
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Your running activity over the past week
              </CardDescription>
            </CardHeader>
            <CardContent>
                      ...
                      <div>
                        ...
                        {day.distance > 0 ? (
                          <div className="text-sm text-gray-500">
                            {day.distance} miles • {day.pace}/mile
                          </div>
                        ) : (
          ...
          <Card className="border-0 shadow-sm">
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Track your progress toward running goals
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <Card className="border-0 shadow-sm">
              <CardHeader className="pb-3">
                ...
                <CardDescription>
                  Weekly training stress balance
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center">
                  <div className="text-3xl font-bold text-indigo-600 mb-2">
                    {mockWeeklyMetrics.trainingLoad}
                  </div>
            ...
            <Card className="border-0 shadow-sm">
              <CardHeader className="pb-3">
                ...
                <CardDescription>
                  How ready you are for your next run
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center">
                  <div className="text-3xl font-bold text-green-600 mb-2">
                    {mockWeeklyMetrics.recoveryScore}%
                  </div>
