...
const features = [
  ...
  },
  {
    ...
    description: "Dive deep into your performance with detailed analytics, route visualization, and trend analysis.",
    icon: Activity,
    ...
    features: ["Performance tracking", "Route visualization (Coming Soon)", "Trend analysis", "Detailed insights"]
  },
  {
...
export default function EnhancedFeaturesSection() {
  return (
    <section id="features" className="py-20 bg-gradient-to-b from-indigo-50 via-gray-50 to-white">
                      ...
                      {feature.comingSoon ? (
                          ...
                          <div className="max-w-md mx-auto">
                            <div className="w-full h-64 bg-gradient-to-br from-yellow-100 to-orange-100 rounded-lg border-2 border-dashed border-yellow-300 flex items-center justify-center">
                              <div className="text-center">
                                ...
                                <p className="text-yellow-600 text-sm">Launching in the next few days</p>
                                <div className="mt-3">
                        ...
                        <div className="p-4">
                          <Image
                            ...
                            alt={feature.alt}
                            width={feature.title === "Activity Analytics" ? 800 : 600}
                            height={feature.title === "Activity Analytics" ? 500 : 400}
