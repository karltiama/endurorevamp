      ...
      <Card>
        ...
        <CardContent>
          <div className="text-sm space-y-2">
            <p>
              <strong>Start:</strong>{' '}
              {new Date(debugInfo.currentWeek.start).toLocaleDateString()}
            </p>
            <p>
              <strong>End:</strong>{' '}
              {new Date(debugInfo.currentWeek.end).toLocaleDateString()}
            </p>
            <p>
            ...
            {debugInfo.currentWeek.activities.length > 0 ? (
              <div className="mt-3 space-y-2">
                ...
                {debugInfo.currentWeek.activities.map(
                  (activity: WeekActivity, index: number) => (
        ...
        <Card key={index}>
          ...
          <CardContent>
            <div className="text-sm space-y-2">
              ...
              <p>
                <strong>End:</strong> {new Date(week.end).toLocaleDateString()}
              </p>
              <p>
                <strong>Activities:</strong> {week.activities.length}
              </p>
              ...
              {week.activities.length > 0 && (
                <div className="mt-3 space-y-2">
                  ...
                  {week.activities.map(
                    (activity: WeekActivity, actIndex: number) => (
                      <div
                        key={actIndex}
