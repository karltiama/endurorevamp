    ...
    <div className="container mx-auto py-8 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          This page helps debug issues with the weekly training load widget and progress calculation.
        </p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <h3 className="text-lg font-semibold text-blue-900 mb-2">Troubleshooting Guide</h3>
        <div className="text-sm text-blue-800 space-y-2">
          <p><strong>If progress isn&apos;t updating:</strong></p>
          <ul className="list-disc list-inside space-y-1 ml-4">
            <li>Check if activities have TSS calculated (look for &quot;TSS Calculation Needed&quot; warning)</li>
          ...
          <ul className="list-disc list-inside space-y-1 ml-4">
            <li>Activities without TSS will show estimated values (less accurate)</li>
