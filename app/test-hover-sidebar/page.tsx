  ...
  return (
    <div className="fixed top-4 right-4 bg-black text-white p-4 rounded-lg z-50">
      <div className="text-sm font-mono">
        <div>
          State: <span className="text-yellow-300">{state}</span>
        </div>
        <div>
          Hovered:{' '}
          <span className="text-blue-300">{isHovered ? 'true' : 'false'}</span>
        </div>
      </div>
    </div>
  );
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ol className="list-decimal list-inside space-y-2">
                  <li>
                    The sidebar should start in collapsed mode (showing only
                    icons)
                  </li>
                  <li>
                    When you hover over the sidebar, it should expand
                    horizontally over this content
                  </li>
                  <li>
                    The main content should NOT shift - the sidebar overlays on
                    top
                  </li>
                  <li>
                    When you move your mouse away, it should collapse back to
                    icon-only mode
                  </li>
                </ol>
                ...
                <div className="mt-6 p-4 bg-gray-100 rounded">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    ...
                    <li>
                      On hover: Expands to full width (16rem / 256px) as an
                      overlay
                    </li>
                    <li>Text labels appear (no group headings)</li>
                    <li>
                      Main content stays in place (doesn&apos;t shift right)
                    </li>
