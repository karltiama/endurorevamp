...
export const metadata: Metadata = {
  ...
  description:
    'Learn how EnduroRevamp collects, uses, and protects your personal information and fitness data.',
};
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              EnduroRevamp (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;)
              is committed to protecting your privacy. This Privacy Policy
              explains how we collect, use, disclose, and safeguard your
              information when you use our fitness application and related
              services.
            </p>
            <p>
              By using EnduroRevamp, you agree to the collection and use of
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-gray-600 mb-2">
                We integrate with Strava to access your fitness data. This
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-600">
                ...
                <li>
                  Your explicit consent when connecting your Strava account
                </li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-600">
                ...
                <li>
                  We do not share your fitness data with third parties (except
                  as required for core functionality)
                </li>
              </ul>
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600">
              EnduroRevamp is not intended for children under 13 years of age.
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <p>
                <strong>Email:</strong> privacy@endurorevamp.com
              </p>
              <p>
                <strong>Support:</strong> Use the in-app support feature
              </p>
              <p>
                <strong>Data Requests:</strong> Contact us for data access or
                deletion
              </p>
            </div>
          </CardContent>
      ...
      <div className="text-center text-sm text-gray-500">
        ...
        <p className="mt-2">
          ...
          <Link
            href="/docs/LOCATION_PRIVACY_POLICY.md"
